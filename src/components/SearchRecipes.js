...
class SearchRecipes extends Component {
    ...
    search() { 
        // short way to implement to variable into the url
        let { ingredients,dish}= this.state;
        const url = `http://www.recipepuppy.com/api/?i=${ingredients}&q=${dish}`
        // const url = `http://www.recipepuppy.com/api/?i=${this.state.ingredients}&q=${this.state.dish}`; //long way to was the url
